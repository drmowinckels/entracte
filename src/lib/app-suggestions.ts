...
export const APP_SUGGESTIONS: AppSuggestion[] = [
  ...
  { label: "Microsoft Teams", tokens: { macos: "teams", windows: "teams", linux: "teams" } },
  { label: "Slack", tokens: { macos: "slack", windows: "slack", linux: "slack" } },
  { label: "Webex", tokens: { macos: "webex", windows: "webex", linux: "webex" } },
  { label: "Discord", tokens: { macos: "discord", windows: "discord", linux: "discord" } },
  ...
  { label: "OBS Studio", tokens: { macos: "obs", windows: "obs", linux: "obs" } },
...
export function tokenFor(suggestion: AppSuggestion, platform: Platform): string | null {
